...
#
#  Output:
#    ~/video2sim-conda2/data/input/custom/plant/instance_mask/
# ============================================================
...
TRANSFORMS=~/video2sim-conda2/data/input/custom/plant/transforms.json
...
FRAME_COUNT=$(ls ~/video2sim-conda2/data/input/custom/plant/images/ | wc -l)
echo "Frames found: ${FRAME_COUNT}"

# Confirm prompts.txt exists
PROMPTS=~/video2sim-conda2/data/input/custom/plant/prompts.txt
if [ ! -f "$PROMPTS" ]; then
...
mkdir -p ~/video2sim-conda2/data/input/custom/plant/instance_mask
mkdir -p ~/video2sim-conda2/data/cache/sam3
...
export HF_HOME=/home/crajashekhar/video2sim-conda2/data/cache/sam3
...
cd ~/video2sim-conda2/data/input/custom/plant

echo "Starting SAM3 inference..."
/home/crajashekhar/.conda/envs/da3_env/bin/python3 \
  /home/crajashekhar/video2sim-conda2/repo/modules/sam3/sam3_process.py
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  ~/video2sim-conda2/data/input/custom/plant/instance_mask/"
    MASK_COUNT=$(ls ~/video2sim-conda2/data/input/custom/plant/instance_mask/ | wc -l)
