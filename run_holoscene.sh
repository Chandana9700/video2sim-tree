...
#SBATCH --output=/home/crajashekhar/video2sim-conda2/holoscene_plant_%j.log
...
export DATA_ROOT=/home/crajashekhar/video2sim-conda2/data/input/custom
export OUTPUT_ROOT=/home/crajashekhar/video2sim-conda2/data/output/custom
export IMG_WIDTH=480
export IMG_HEIGHT=848
...
export PYTHONPATH=/home/crajashekhar/video2sim-conda2/holoscene_src:/home/crajashekhar/video2sim-conda2/holoscene_src/MVMeshRecon:${PYTHONPATH}
export CACHE_ROOT=/home/crajashekhar/video2sim-conda2/data/cache/holoscene
...
${PYTHON} -c "import tinycudann; print('tinycudann already installed')" 2>/dev/null || {
    ...
    cd /home/crajashekhar/video2sim-conda2/tinycudann_src/bindings/torch
    ...
    cd /home/crajashekhar/video2sim-conda2
}
...
${PYTHON} -c "import gsplat; print('gsplat already installed')" 2>/dev/null || {
    ...
    ${PYTHON} -m pip install --no-build-isolation \
        /home/crajashekhar/video2sim-conda2/gsplat_src 2>&1 | tail -50
}
...
${PYTHON} -c "import nvdiffrast; print('nvdiffrast already installed')" 2>/dev/null || {
    ...
    export LD_LIBRARY_PATH=${CUDA_ROOT}/lib64/stubs:${CUDA_ROOT}/lib64:${LD_LIBRARY_PATH}
    ${PYTHON} -m pip install --no-build-isolation \
        /home/crajashekhar/video2sim-conda2/nvdiffrast_src 2>&1 | tail -5
}
...
${PYTHON} -c "from pytorch3d import _C; print('pytorch3d already built')" 2>/dev/null || {
    ...
    export MAX_JOBS=8
    ${PYTHON} -m pip install --no-build-isolation \
        /home/crajashekhar/video2sim-conda2/pytorch3d_build 2>&1 | tail -10
}
...
# ── Run HoloScene ─────────────────────────────────────────────────────────────
mkdir -p "${OUTPUT_ROOT}"
cd /home/crajashekhar/video2sim-conda2/repo/modules/holoscene
...
bash /home/crajashekhar/video2sim-conda2/repo/modules/holoscene/hs_process.sh
